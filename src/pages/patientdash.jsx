                    ...
                    <div className="bg-white rounded-2xl shadow p-6">
                        ...
                        <ul className="space-y-2">
                            {diseases.map((d) => (
                                <li
                                    key={d.id}
                                    className="flex flex-wrap justify-between items-center px-4 py-2 bg-gray-50 rounded-lg"
                                >
                                    <span>{d.diseasename}</span>
                                    {d.verifiedDoctor && <span className="text-sm text-gray-600">Verified By: Dr. {d.verifiedDoctor}</span>}
                                    <span
                ...
                {active === "settings" && (
                    <div className="bg-white rounded-2xl shadow p-6 max-w-md mx-auto space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" value={bloodpressure} onChange={(e) => setBloodpressure(e.target.value)} className="w-full p-2 border rounded-lg" />
                        </div>
                        <div>
                            <label className="block text-gray-600 mb-1">Blood Group</label>
                            <select value={bloodgroup} onChange={(e) => setBloodgroup(e.target.value)} className="w-full p-2 border rounded-lg">
                        ...
                        <div>
                            ...
                            <input type="text" value={sugar} onChange={(e) => setSugar(e.target.value)} className="w-full p-2 border rounded-lg" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} className="w-full p-2 border rounded-lg" />
                        </div>
                        <button
                            onClick={async () => {
                                const data = {
