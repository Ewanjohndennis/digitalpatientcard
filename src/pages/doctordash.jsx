...
export default function DoctorDashboard() {
    ...
    const doctordashboard = async () => {
        setloading(true);
        try {
            const response = await axios.get("https://digitalpatientcardbackend.onrender.com/doctor/dashboard");
    ...
    const verifyDisease = async (patientId, diseaseid) => {
        setloading(true);
        try {
            const response = await axios.post("https://digitalpatientcardbackend.onrender.com/doctor/verify", null, {
    ...
    const handleReferralSubmit = async () => {
        ...
        setloading(true);
        try {
            const response = await axios.post("https://digitalpatientcardbackend.onrender.com/doctor/refer", null, {
                params: {
    ...
    const downloadPDF = async (username) => {
        ...
        try {
            const response = await axios.get(
                `https://digitalpatientcardbackend.onrender.com/download/patient-pdf`,
                {
                    params: { username },
                    responseType: "blob",
                }
